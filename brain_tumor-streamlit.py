...
def prediction_page():
    st.image(r"C:\Users\AFIFI FAIZ\Documents\TumorDeploy\ss\ai.png", use_column_width=True)
...
# History Page
def history_page():
    st.image(r"C:\Users\AFIFI FAIZ\Documents\TumorDeploy\ss\his.png", use_column_width=True)
...
def dataset_page():
    st.image(r"C:\Users\AFIFI FAIZ\Documents\TumorDeploy\ss\data.png", use_column_width=True)
...
def main():
    ...
    st.sidebar.image(r"C:\Users\AFIFI FAIZ\Documents\TumorDeploy\ss\ailogo.png", use_column_width=True)
